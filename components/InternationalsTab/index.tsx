...
import InternationalsTabItem from "./InternationalsTabItems";
import internationalsTabData from "./internationalsTabData";

import { motion } from "framer-motion";

const InternationalsTab = () => {
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {internationalsTabData.map((team, key) => (
              <div
                className={team.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <InternationalsTabItem featureTab={team} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
...
export default InternationalsTab;