    ...
    <section className="relative overflow-hidden pb-20 pt-35 md:pt-40 xl:pb-25 xl:pt-46">
      ...
      <Swiper
            ...
            >
              ...
              <SwiperSlide>
                <Image
                  src="/images/banner/ProductClubLogo.png"
                  alt="Slide 2"
                  className="object-cover w-full h-full"
                  fill
                />
              ...
              <SwiperSlide>
                <Image
                  src="/images/banner/ProductTeam.jpg"
                  alt="Slide 5"
                  className="object-cover w-full h-full"
                  fill
                />
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-8 xl:gap-32.5">
          ...
          >
            <h4 className="mb-4.5 text-lg font-bold text-black dark:text-white">
              🏛️ Welcome to Product Club, IIT Kanpur
            </h4>
            ...
            <p className="text-black dark:text-white">
              The Product Club at IIT-Kanpur is dedicated to enhance creativity and innovation among students. We provide opportunities to explore product design, development, and entrepreneurship, helping students to transform their ideas into real-world solutions.
            </p>
            <div className="mt-10">
            <motion.div
              variants={{
            ...
            >
              <ul className="flex items-center gap-5">
                ...
                <li>
                  <a href="https://in.linkedin.com/company/product-management-interestgroup-iitk" aria-label="social icon">
                    <svg
                ...
                <li>
                  <a href="https://www.instagram.com/productiitk" aria-label="instagram icon">
