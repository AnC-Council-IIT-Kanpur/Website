...
const banners = [
  {
    ...
    slides: [
      { src: '/images/banner/ProductTeam.jpg', alt: 'Slide 1' },
      { src: '/images/banner/productBannerLight2.jpg', alt: 'Slide 2' },
      { src: '/images/banner/productBannerLight3.jpg', alt: 'Slide 3' }
    ]
  },
  {
    delay: 3000,
    ...
    slides: [
      { src: '/images/banner/ProductTeam.jpg', alt: 'Slide 1' },
      { src: '/images/banner/productBannerDark2.jpg', alt: 'Slide 2' },
      { src: '/images/banner/productBannerDark3.jpg', alt: 'Slide 3' }
    ]
  }
];
...
const achivements = [
  {
    ...
    link: <a href="https://drive.google.com/drive/folders/1lNkiXZcBnLbzZrkuNHwub1DQhQw763cy">Our Submission</a>
  },
  {
    icon: faBullhorn,
...
const calendarInfo = {
  ...
  description: "The Product Club organizes a variety of events and workshops aimed at innovation and entrepreneurship among students. Join us for engaging sessions on product development, startup strategies, and industry insights. Stay updated with our calendar to participate in our upcoming activities.",
  buttonText: "Calendar",
  buttonUrl: "#",
};
