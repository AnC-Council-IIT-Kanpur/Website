...
import productClubTabs from "./productClubTabs"; // Assuming you have a file with tab data specific to the Product Club

import { motion } from "framer-motion";

const ProductClubFeaturesTab = () => {
  const [currentTab, setCurrentTab] = useState(productClubTabs[0].id); // Initialize with the ID of the first tab in the array
...
export default ProductClubFeaturesTab;
