  ...
  return (
    <section id="objectives" className="overflow-hidden pb-20 pt-35 md:pt-40 xl:pb-25 xl:pt-46">
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
        ...
        <div className=" text-center grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          {objectives.map((objective, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg transition-all transform hover:-translate-y-2 duration-300 shadow-solid-3  hover:shadow-solid-4"
            >
              <FontAwesomeIcon
                icon={objective.icon}
